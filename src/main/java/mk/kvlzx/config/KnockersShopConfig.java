...
public class KnockersShopConfig {
    ...
    static {
        ...
        KNOCKER_MATERIALS.put("wooden_shovel", new KnockerMaterial(Material.WOOD_SPADE, 0));
        ...
        KNOCKER_MATERIALS.put("iron_shovel", new KnockerMaterial(Material.IRON_SPADE, 0));
        ...
        KNOCKER_MATERIALS.put("diamond_shovel", new KnockerMaterial(Material.DIAMOND_SPADE, 0));
        KNOCKER_MATERIALS.put("golden_shovel", new KnockerMaterial(Material.GOLD_SPADE, 0));
